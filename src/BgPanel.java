/**
 * __Panel for choosing the background of the game
...
public class BgPanel extends JPanel {
  ...
  public String getBG()
  {
    if(galaxyButton.isSelected())
      return "src/GWAGimages/galaxy.jpg";
    else if(forestButton.isSelected())
      return "src/GWAGimages/forest.jpg";
    else if(desertButton.isSelected())
      return "src/GWAGimages/desert.jpg";
    else if(seaButton.isSelected())
      return "src/GWAGimages/sea.jpg";
    else
      return null;
  }
  public void addMA(MouseAdapter mL)
  {
    nextImage.addMouseListener(mL);
  }

...
public class QPanelPicOnline extends JPanel
{
  ...
  private Timer timer;
  public QPanelPicOnline(PictureCompletionQuestion qe, int pts)
  {
    a = 0;
    b=0;
    c=0;
    ...
    imgg = "minion";
      ...
      imgg = "police";
    try {
      sel = ImageIO.read(new File("GWAGimages/puzzleBorder.gif"));
    } catch(IOException e) {
      e.printStackTrace();
    }
...
//  });
    ...
    lblNewLabel_1.setIcon(new ImageIcon("GWAGimages/" + imgg + ".png"));
